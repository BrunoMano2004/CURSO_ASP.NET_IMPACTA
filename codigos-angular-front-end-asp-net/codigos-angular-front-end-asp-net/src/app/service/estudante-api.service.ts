...
/*==================================================================
  ...
  apiUrlBase: string = 'http://localhost:5205/api/Estudante'
  ...
  recTodosOsRegistros(): Observable<Estudante>{
    ...
    // http://localhost:1234/api/Estudante/GetAll
    return this.httpReq.get<Estudante>(this.apiUrlBase+'/GetAll')
    .pipe(
  ...
  recUmRegistro(id: any): Observable<Estudante>{
    ...
    return this.httpReq.get<Estudante>(this.apiUrlBase+'/GetOne/'+id)
    .pipe(
      retry(1),
      catchError(this.observarBug)
    )
  ...
  inserirRegistro(dadosRecebidos: any): Observable<Estudante>{
    // http://localhost:1234/api/Estudante/AddRegister
    
    return this.httpReq.post<Estudante>(this.apiUrlBase+'/AdicRegistro', JSON.stringify(dadosRecebidos), this.cruzamentoDominio)
    .pipe(
      retry(1),
      catchError(this.observarBug)
    )
  ...
  atualizarRegistro(id: any, dadosAlterados:any): Observable<Estudante>{
    // http://localhost:1234/api/Estudante/UpRegister/:id

    return this.httpReq.put<Estudante>(this.apiUrlBase+'/UpRegister/'+id, JSON.stringify(dadosAlterados), this.cruzamentoDominio)
    .pipe(
      retry(1),
      catchError(this.observarBug)
    )
  ...
  exclusaoRegistro(id: any){
    // http://localhost:1234/api/Estudante/delRegister/:id

   return this.httpReq.delete<Estudante>(this.apiUrlBase+'/delRegister/'+id, this.cruzamentoDominio)
   .pipe(
    retry(1),
    catchError(this.observarBug)
  )
